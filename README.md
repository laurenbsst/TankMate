...
<h2 align="center">TankMate</h3>
  <p align="center">
    A maintenance tool to aid fishkeepers with monitoring water parameters, keeping track of livestock, and general tank maintenance.
    <br />
    <a href="https://github.com/laurenbsst/TankMate"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/laurenbsst/TankMate">View Demo</a>
    ·
    <a href="https://github.com/laurenbsst/TankMate/issues">Report Bug</a>
    ·
    <a href="https://github.com/laurenbsst/TankMate/issues">Request Feature</a>
  </p>
</div>
...
See the [open issues](https://github.com/laurenbsst/TankMate/issues) for a full list of proposed features (and known issues).
